...
public class AppSettings
{
    ...
    /// <summary>音量平均（客户端按歌曲响度归一，服务器未提供 ReplayGain 时仍能拉平音量）。</summary>
    public bool VolumeNormalization { get; set; } = true;

    /// <summary>当前主题 id（dark/light/forest/midnight/sunset/rose）。深浅只是其中两套主题。</summary>
